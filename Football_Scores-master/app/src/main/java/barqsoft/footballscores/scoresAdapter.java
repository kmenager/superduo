...
public class scoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.home_crest.setContentDescription(String.format(
                context.getString(R.string.icon_content_desc), cursor.getString(COL_HOME)));
        mHolder.away_crest.setImageResource(Utilies.getTeamCrestByTeamName(
                cursor.getString(COL_AWAY)));
        mHolder.away_crest.setContentDescription(String.format(
                context.getString(R.string.icon_content_desc), cursor.getString(COL_AWAY)));
        ...
        if (mHolder.match_id == detail_match_id) {
            ...
            match_day.setText(Utilies.getMatchDay(context,
                    cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE)));
            match_day.setContentDescription(Utilies.getMatchDay(context,
                    cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE)));
