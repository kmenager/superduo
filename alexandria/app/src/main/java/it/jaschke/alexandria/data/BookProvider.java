        ...
        switch (uriMatcher.match(uri)) {
            ...
            case BOOK_FULLDETAIL:
                String[] bfd_projection ={
                    ...
                    AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.PAGE_COUNT,
                    AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.PUBLISHED_DATE,
                    AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract.BookEntry.PUBLISHER,
